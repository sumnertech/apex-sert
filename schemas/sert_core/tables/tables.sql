...
ALTER TABLE builder_urls ADD CONSTRAINT builder_urls_pk PRIMARY KEY ( builder_url_id );

ALTER TABLE builder_urls ADD CONSTRAINT builder_urls_un UNIQUE ( builder_url_key );
...
ALTER TABLE eval_history ADD CONSTRAINT eval_history_pk PRIMARY KEY ( eval_history_id );
...
CREATE TABLE eval_results_history (
...
ALTER TABLE eval_results_history ADD CONSTRAINT eval_results_history_pk PRIMARY KEY ( eval_results_history_id );
...
ALTER TABLE eval_results_history
    ADD CONSTRAINT erh_eval_history_fk FOREIGN KEY ( eval_history_id )
        REFERENCES eval_history ( eval_history_id )
            ON DELETE CASCADE
    NOT DEFERRABLE;
...
ALTER TABLE rules
    ADD CONSTRAINT rules_builder_urls_fk FOREIGN KEY ( builder_url_id )
        REFERENCES builder_urls ( builder_url_id )
    NOT DEFERRABLE;

CREATE OR REPLACE TRIGGER BI_EXCEPTIONS 
...
CREATE OR REPLACE TRIGGER BU_BUILDER_URLS 
    BEFORE UPDATE ON BUILDER_URLS 
    FOR EACH ROW 
begin
